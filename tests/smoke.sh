...
assert_grep '"prepare": "lefthook install"' "package.json"
assert_grep '"check:test": "npm test"' "package.json"
assert_grep '"check:build": "npm run build"' "package.json"
assert_grep '"check:smoke": "bash tests/smoke.sh"' "package.json"
assert_grep '"check:terraform": "terraform -chdir=terraform validate"' "package.json"
...
assert_grep 'lefthook' "README.md"
assert_grep 'pre-commit' "README.md"
assert_grep 'pre-push' "README.md"
assert_grep '^pre-commit:' "lefthook.yml"
assert_grep '^pre-push:' "lefthook.yml"
assert_grep 'npm run check:smoke' "lefthook.yml"
assert_grep 'npm run check:test' "lefthook.yml"
assert_grep 'npm run check:build' "lefthook.yml"
assert_grep 'npm run check:terraform' "lefthook.yml"
